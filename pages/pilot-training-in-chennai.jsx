...
export default function PilotTrainingChennai() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Chennai – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Chennai students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Chennai with Placement Assistance',
            }}
