...
const eligibilityList = [
    ...
    'Physics and Mathematics at the 10+2 level \u2014 the subjects are the gate, not the board. CBSE and ICSE candidates meet it identically, and neither needs an equivalence certificate; only international-board candidates do. Worth knowing before you drop a subject: an Aircraft Maintenance Engineer needs Physics, Chemistry AND Mathematics, so dropping Chemistry closes that route while leaving the pilot route open.',
