    ...
    <>
      ...
      >
        ...
        <div className="bg-av-orange py-4 text-center">
          {/*
            Restored to <h1>. The comment above says an <h1> was added here, but
            the element had been downgraded to <h2> — almost certainly to work
            around HeroSlider hardcoding its own <h1>, which gave this page two.
            The slider now takes asH1={false}, so this can be the real heading
            again, and it is the better one: the slider says "Your Dream of
            Flying / Starts Here", while this states what the page is actually
            about.
          */}
