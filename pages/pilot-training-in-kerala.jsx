...
export default function PilotTrainingKerala() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Kerala – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Kerala students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Kerala with Placement Assistance',
            }}
