...
export default function PilotTrainingNoida() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Noida – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Noida students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Noida with Placement Assistance',
            }}
