        ...
        >
            ...
            <header className="bg-gradient-to-br from-av-blue via-av-navy to-av-blue py-20 px-4 text-center">
                <ScrollReveal>
                    ...
                    <h1 className="font-montserrat text-4xl md:text-6xl font-black text-white mb-4 leading-tight drop-shadow-lg" style={{ textShadow: '0 4px 12px rgba(0,0,0,0.5)' }}>
                            ...
                            <div className="bg-white rounded-2xl border border-gray-100 shadow-lg p-8 h-full">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <p className="text-gray-600 text-sm leading-relaxed mt-4">
                                        If you are preparing for DGCA exams in Maharashtra, our Mumbai guide includes exam-centre addresses, local travel tips and recommended nearby simulators to help you plan effectively: <Link href="/pilot-training-in-india" className="text-av-orange font-semibold hover:underline">Pilot Training in Mumbai</Link>.
                                    </p>
                            </div>
                        </ScrollReveal>
                    </div>
