...
export default function PilotTrainingDelhi() {
    return (
        <CityPageTemplate
            city="Delhi"
            canonical="https://www.weoneaviation.in/pilot-training-in-delhi"

            meta={{
                title: 'Pilot Training in Delhi: Fees, Courses & How to Start',
                description: 'A guide to pilot training in Delhi: course options, fees, eligibility, DGCA ground classes and how to choose the right institute.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Delhi with Placement Assistance',
            }}
            ...
            features={[
                ...
                { icon: '🏆', title: 'Focused DGCA Exam Coaching', desc: 'Students who regularly attend our classes are well prepared for their first attempt at DGCA exams and can become a pilot in just 15 months.' },
            ]}
            ...
            whyWeOne={[
                ...
                'Established in 2011 — DGCA-focused pilot training',
