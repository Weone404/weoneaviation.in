...
const hardcodedBlogs = [
    ...
    { id: 2, title: 'DGCA Written Exams: Subjects, Pattern & Preparation Tips', excerpt: 'Ace all 9 DGCA written exams with our expert preparation strategy. Know the syllabus, exam pattern, and recommended study materials.', category: 'DGCA', readTime: '6 min', date: 'Dec 10, 2026', img: '/Dgca written exam subject pattern and preparation tips.jpeg', faqs: [] },
    ...
    { id: 5, title: 'Medical Requirements to Become a Pilot in India – DGCA Class 1', excerpt: 'Detailed guide on DGCA Class 1 medical requirements, what conditions are disqualifying, and how to prepare for the medical exam.', category: 'Medical', readTime: '6 min', date: 'Nov 20, 2026', img: '/Pilot-Salary.webp', faqs: [] },
