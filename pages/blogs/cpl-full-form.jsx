...
export default function CPL() {
    return (
        <Layout title="Commercial Pilot License (CPL) Training in India" description="DGCA approved CPL training in India. Become a commercial pilot with WeOne Aviation Academy. Expert instructors, modern aircraft, Placement Assistance.">
