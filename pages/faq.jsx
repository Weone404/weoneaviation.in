...
const categories = [
  ...
  },
  {
    ...
    faqs: [
      { question: 'What pilot-training courses are available?', answer: 'We One Aviation provides guidance for Commercial Pilot License (CPL), Private Pilot License (PPL), Airline Transport Pilot License (ATPL), Student Pilot License (SPL), and DGCA ground classes.' },
      ...
      { question: 'What are the usual PPL eligibility requirements?', answer: 'PPL applicants generally need to meet the applicable minimum age, education, English, and DGCA medical requirements. Requirements should be confirmed under current DGCA rules.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What career support does We One Aviation provide?', answer: 'We provide interview preparation and career guidance: airline interview practice, licence-route planning, and information about openings we are aware of. We do not place students in jobs and we make no hiring promise. Ask us what the current scope is for your course.' },
