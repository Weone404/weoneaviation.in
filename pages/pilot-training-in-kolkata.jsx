...
export default function PilotTrainingKolkata() {
    return (
        <CityPageTemplate
            city="Kolkata"

            meta={{
                title: 'Pilot Training Institute in Kolkata 2025 | CPL, PPL, DGCA | WeOne Aviation',
                description: 'Best Pilot Training Institute in Kolkata. CPL, PPL, ATPL, DGCA Ground Classes. 3000+ pilots trained. 100% placement assistance. Scholarship available. Join WeOne Aviation Academy.',
            }}

            hero={{
                image: 'https://images.unsplash.com/photo-1587019158091-1a103c5dd17f?w=1920&q=80',
                tag: 'Pilot Training in Kolkata',
                title: 'Pilot Training Institute in Kolkata – 2025',
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Kolkata with 100% Placement Assistance',
            }}

            intro="Are you dreaming of a career in aviation? Our World Class Pilot Training Institute in Kolkata is best for you if you want to become a pilot — whether you are looking for Commercial Pilot Training, Private Pilot Training or aiming to become an airline captain. We provide all types of Pilot Training with experienced flight instructors and the latest technology available at our academy. Kolkata is a major aviation center in West Bengal and India, creating a high demand for trained pilots — and we are here to train the next generation of aviation professionals."
            ...
            courses={[
                {
                    ...
                    desc: 'Want to fly massive planes for big airlines? Our CPL program at the Pilot Training Institute in Kolkata is your ticket to the cockpit. Our pro instructors — real pilots with real experience — teach you to handle everything like a champ. Soon, you\'ll be landing jobs with the coolest airlines!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Want to fly around for fun? Our PPL program at the Pilot Training Institute in Kolkata is just right for you. Take your friends up in the sky or chill above the city — we keep it simple and exciting. Fly by yourself, however you like!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Our DGCA Ground Classes at the Pilot Training Institute in Kolkata make it super easy to learn air navigation, meteorology, and air regulations — all approved by DGCA. Crack your DGCA exams without any tension with We One Aviation Academy!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Improve your flying skills with advanced aircraft training at our Pilot Training Institute in Kolkata. Designed for pilots who want to enhance their abilities and qualify for commercial aviation roles.',
                    details: [
            ...
            career={{
                intro: 'Kolkata is a major aviation center in West Bengal with great job options for trained pilots. Once you finish your training, you can try for jobs like these:',
                options: [
            ...
            syllabus={[
                { num: '1', title: 'Air Regulations', desc: 'The rulebook for flying — covers all the laws and guidelines pilots must follow, including airspace rules and safety standards. The "traffic rules" of the sky over Kolkata and beyond.' },
                ...
                { num: '3', title: 'Air Navigation', desc: 'Your GPS guide to flying! Learn how to find your way using maps, instruments, and calculations — from Kolkata to anywhere across India or beyond.' },
            ...
            fees={{
                ...
                whyChanges: [
                    ...
                    { title: 'City & Location (Kolkata)', desc: 'Kolkata\'s city environment means pilot training costs are slightly higher compared to smaller towns.' },
            ...
            faqs={[
                { q: 'How long does it take to complete pilot training in Kolkata?', a: 'PPL takes 4-6 months, CPL takes 12-18 months, and ATPL requires additional experience after CPL. DGCA Ground Classes take 3-6 months.' },
                { q: 'What are the fees for pilot training in Kolkata?', a: 'The average fees for CPL training in Kolkata is INR 40–60 Lakh. This includes ground classes (INR 2-3 lakhs), 200 hours of flying (INR 35-55 lakhs), simulator training (INR 3-5 lakhs), and extra gear (INR 20-50 thousand). WeOne Aviation provides scholarship and flexible payment options.' },
                { q: 'What is the eligibility to become a pilot in Kolkata?', a: 'Minimum age of 17 years, 10+2 with Physics & Mathematics, DGCA Class 1 & Class 2 Medical clearance, and English proficiency are required.' },
                { q: 'Does WeOne Aviation provide placement assistance in Kolkata?', a: 'Yes! We provide 100% placement assistance. Our graduates have successfully joined major airlines, cargo operations, and private aviation companies worldwide.' },
                { q: 'Can I get a scholarship for pilot training in Kolkata?', a: 'Yes! WeOne Aviation Academy provides scholarships to every deserving student along with a flexible fees structure and loan assistance to make pilot training affordable.' },
                { q: 'What career options are available after pilot training in Kolkata?', a: 'After completing pilot training, you can work as a Commercial Airline Pilot (IndiGo, Air India, SpiceJet), Private Pilot, Cargo Pilot (FedEx, Blue Dart), Flight Instructor, or Charter Pilot. Kolkata\'s growing aviation sector in West Bengal creates excellent demand for trained pilots.' },
            ]}
        />
    );
}