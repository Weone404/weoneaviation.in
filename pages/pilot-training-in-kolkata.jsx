...
export default function PilotTrainingKolkata() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Kolkata – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Kolkata students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Kolkata with Placement Assistance',
            }}
