...
export default function PilotTrainingHyderabad() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Hyderabad – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Hyderabad students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
