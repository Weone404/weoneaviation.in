...
export default function PilotTrainingHyderabad() {
    return (
        <CityPageTemplate
            city="Hyderabad"
            ...
            courses={[
                ...
                },
                {
                    ...
                    desc: 'Our DGCA Ground Classes in Hyderabad make it super easy to learn navigation, meteorology, and air regulations — all approved by DGCA. Crack your exams without any tension!',
                    details: [
            ...
            career={{
                intro: 'Hyderabad is a major aviation hub in India with great job options for trained pilots. Once you finish your training, you can work in any of these exciting roles:',
                options: [
                    { icon: '✈️', title: 'Commercial Pilot', desc: 'Fly passenger planes for airlines like IndiGo, Air India, or SpiceJet.' },
            ...
            syllabus={[
                ...
                { num: '2', title: 'Aviation Meteorology', desc: 'Learn to read weather patterns — clouds, winds, storms, and temperature changes — to plan safe flights and avoid turbulence.' },
                ...
                { num: '6', title: 'Radio Telephony', desc: 'Learn how to communicate with ATC and other pilots using radio codes and phrases to keep everything clear and safe.' },
            ]}
            ...
            fees={{
                ...
                whyChanges: [
                    ...
                    { title: 'City & Location (Hyderabad)', desc: 'City-based training in Hyderabad costs slightly more compared to smaller towns due to higher operational costs.' },
                    { title: 'Type of Aircraft', desc: 'Basic trainer aircraft vs fancy jet simulators — advanced equipment means higher training costs.' },
            ...
            faqs={[
                ...
                { q: 'What is the eligibility to become a pilot in Hyderabad?', a: 'A Commercial Pilot Licence requires a minimum age of 18 years on the date of application (Aircraft Rules, 1937, Schedule II, Section J). Flight training can begin earlier: a Student Pilot Licence requires 16 years (Schedule II, Section B). 10+2 with Physics & Mathematics, DGCA Class 1 & Class 2 Medical clearance, and English proficiency are also required.' },
