...
export default function PilotTrainingGoa() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Goa – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Goa students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Goa with Placement Assistance',
            }}
