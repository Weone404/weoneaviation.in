...
export default function ATPL() {
  return (
    <CoursePageTemplate
      meta={{ title: 'ATPL Training in India | Airline Transport Pilot License', description: 'ATPL training in India – the highest pilot certification. Become an airline captain with WeOne Aviation Academy. DGCA ATPL exam prep and guidance.' }}
