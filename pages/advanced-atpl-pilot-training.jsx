...
export default function ATPL() {
  return (
    <CoursePageTemplate
      meta={{ title: 'ATPL Training in India | Airline Transport Pilot License | We One Aviation', description: 'ATPL training in India – the highest pilot certification. Become an airline captain with We One Aviation Academy. DGCA ATPL exam prep and guidance.' }}
      ...
      facts={[['6 months', 'Total Duration'], ['1500 hours', 'Min Flight Hours'], ['CPL holder', 'Eligibility'], ['₹15-25 Lakh', 'ATPL Prep Fee']]}
      ...
      career={{ text: 'ATPL is required to become an airline captain. Pay varies by airline and experience.', salary: 'Varies by airline and experience', salaryLabel: 'Senior Captain at major airlines' }}
    />
  );
}
