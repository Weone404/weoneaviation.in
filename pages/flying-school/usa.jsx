...
export default function USAFlightTraining() {
    ...
    return (
        <Layout title="Commercial Pilot License in USA – FAA Approved CPL Training | WeOne Aviation Academy" description="Earn your Commercial Pilot License in the USA with FAA-approved training — 250 flying hours in ~1.6 years, plus PPL, CPL, IR and multi-engine ratings via WeOne Aviation.">
