...
export default function USAFlightTraining() {
    ...
    return (
        <Layout title="Commercial Pilot License in USA – FAA CPL | WeOne" description="FAA-approved CPL training in the USA with WeOne Aviation: 250 hours in ~1.6 years, PPL, CPL, IR and multi-engine ratings.">
