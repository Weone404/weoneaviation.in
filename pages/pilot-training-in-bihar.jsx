...
export default function PilotTrainingBihar() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Bihar – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Bihar students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Bihar with Placement Assistance',
            }}
