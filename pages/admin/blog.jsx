    ...
    return (
        <>
            {/*
              ...
              from unpkg in _document.jsx — which put ~25 KB of editor CSS and
              887 ms of render-blocking time on all 93 public pages. Served from
              /public so it stays on this origin; Next only permits global CSS
              imports from _app, so a <link> is the way to scope it to a page.
            */}
            <Head>
