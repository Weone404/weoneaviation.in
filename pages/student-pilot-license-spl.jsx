...
export default function SPL() {
  return (
    <CoursePageTemplate
      meta={{ title: 'Sport Pilot License (SPL) Training in India | We One Aviation', description: 'Get your Sport Pilot License (SPL) in India. Affordable, fast-track pilot certification for recreational flying. DGCA approved program.' }}
      ...
      currentPath="/student-pilot-license-spl"
