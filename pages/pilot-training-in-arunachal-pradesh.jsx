...
export default function PilotTrainingArunachalPradesh() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Arunachal Pradesh – CPL, PPL & DGCA',
                description: 'DGCA-approved pilot training for Arunachal Pradesh students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Arunachal Pradesh with Placement Assistance',
            }}
