...
export default function CPL() {
    return (
        <Layout title="CPL Flight Training in India | WeOne Aviation" description="DGCA approved CPL training in India. Become a commercial pilot with WeOne Aviation Academy. Expert instructors, modern aircraft, Placement Assistance.">
