...
export default function PilotTrainingTamilNadu() {
    return (
        <CityPageTemplate
            city="Tamil Nadu"

            meta={{
                title: 'Pilot Training in Tamil Nadu – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Tamil Nadu students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Tamil Nadu with Placement Assistance',
            }}
...
Student workflow: Recommended approach — cluster ground classes into 2–3 full days per week, book a simulator session the week before a scheduled DGCA paper, and plan one intensive flying block per month at a quieter aerodrome. We also include local scholarship pointers and real planning notes from recent Tamil Nadu batches so you can make a choice that’s both practical and cost-aware.`}
            ...
            courses={[
                ...
                },
                {
                    ...
                    desc: 'Our DGCA Ground Classes at the Pilot Training Institute in Tamil Nadu make it super easy to learn air navigation, meteorology, and air regulations — all approved by DGCA. Crack your DGCA exams without any tension with We One Aviation Academy!',
                    details: [
            ...
            eligibility={[
                ...
                { icon: '🩺', title: 'Medical Fitness', desc: 'Must clear DGCA Class 1 Medical standards' },
                { icon: '🗣️', title: 'English Proficiency', desc: 'Must be able to read, write, and communicate effectively in English' },
            ]}

            career={{
                intro: 'Tamil Nadu is a major aviation center in South India with great job options for trained pilots. Once you finish your training, you can try for jobs like these:',
                options: [
            ...
            syllabus={[
                { num: '1', title: 'Air Regulations', desc: 'The rulebook for flying — covers all the laws and guidelines pilots must follow, including airspace rules and safety standards. The "traffic rules" of the sky over Tamil Nadu and beyond.' },
                ...
                { num: '3', title: 'Air Navigation', desc: 'Your GPS guide to flying! Learn how to find your way using maps, instruments, and calculations — from Chennai to anywhere across India and beyond.' },
            ...
            fees={{
                ...
                whyChanges: [
                    ...
                    { title: 'City & Location (Tamil Nadu)', desc: 'Tamil Nadu\'s metro environment means pilot training costs are slightly higher compared to smaller towns.' },
