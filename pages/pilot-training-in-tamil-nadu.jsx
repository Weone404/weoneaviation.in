...
Student workflow: Recommended approach — cluster ground classes into 2–3 full days per week, book a simulator session the week before a scheduled DGCA paper, and plan one intensive flying block per month at a quieter aerodrome. We also include local scholarship pointers and real planning notes from recent Tamil Nadu batches so you can make a choice that’s both practical and cost-aware.`}
            ...
            faqs={[
                ...
                { q: 'What is the eligibility to become a pilot in Tamil Nadu?', a: 'A Commercial Pilot Licence requires a minimum age of 18 years on the date of application (Aircraft Rules, 1937, Schedule II, Section J). Flight training can begin earlier: a Student Pilot Licence requires 16 years (Schedule II, Section B). 10+2 with Physics & Mathematics, DGCA Class 1 Medical clearance, and English proficiency are also required.' },
