...
export default function USAFlightTraining() {
    ...
    return (
        <Layout title="Best Flight Schools in USA – FAA Pilot Training" description="Train at FAA-approved flight schools in the USA with WeOne Aviation: 250 hours in ~1.6 years. PPL, CPL, IR and multi-engine training.">
