...
const heroSlides = [
    { id: 1, image: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=1920&q=80', tag: 'Flight Training Abroad', title: 'Best Flight Schools', highlight: 'in U.S.A', sub: 'FAA-Approved Flight Training in the United States' },
];
...
export default function USAFlightTraining() {
    ...
    return (
        <Layout title="Best Flight Schools in USA – FAA Pilot Training | We One Aviation Academy" description="FAA-approved flight training in the United States, arranged through We One Aviation Academy's partner schools: PPL, CPL, Instrument Rating and multi-engine rating training.">
