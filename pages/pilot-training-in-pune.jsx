...
export default function PilotTrainingPune() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Pune – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Pune students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Pune with Placement Assistance',
            }}
