...
export default function DGCAMedical() {
    return (
        <Layout title="DGCA Class 1 & Class 2 Medical – Pilot Guide" description="Guide to DGCA Class 2 and Class 1 medical exams for pilots in India: requirements, steps, fees, validity and eGCA registration.">
