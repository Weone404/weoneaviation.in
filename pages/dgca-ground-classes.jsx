...
const blogs = [
  { title: 'Pilot Training in Delhi', date: 'February 13, 2025', desc: 'Flight Simulator Practice in pilot training Course. DGCA Practice Paper, Private Pilot License (PPL) Course Fees, Full Form of CPL...', href: '/blog/pilot-training-delhi' },
  { title: 'Private Pilot License (PPL) Course Fees', date: 'February 10, 2025', desc: 'Private Pilot License (PPL) Course Fees-2025. If Your Dream To Become a Pilot...', href: '/blog/ppl-course-fees' },
  { title: 'Full Form of CPL | Commercial Pilot License', date: 'January 28, 2025', desc: 'CPL Full Form: Meaning in Aviation, Cricket, Marketing, and More. Have you ever come across the term CPL and wondered what...', href: '/blog/cpl-full-form' },
  { title: 'Master the DGCA CPL Exam: Complete Guide to Syllabus, Subjects, and Success Tips', date: 'January 21, 2025', desc: 'Comprehensive Guide to DGCA Exam Subjects. Master the DGCA CPL Exam with complete syllabus, subjects, and success tips.', href: '/blog/dgca-exam-guide' },
  { title: 'Aviation Course After 12th: Detailed Fees and Admission Guide', date: 'January 2, 2025', desc: 'Discover top aviation courses after 12th with complete details on fees, eligibility, and career options.', href: '/blog/aviation-course-after-12th' },
  { title: 'Aviation Academy', date: 'December 12, 2024', desc: 'We One Aviation Academy: Leading Aviation Training Institute. At WeOneAviation Academy, we turn your passion for aviation into a rewarding career.', href: '/blog/aviation-academy' },
];

export default function DGCAGroundClasses() {
  return (
    <Layout title="DGCA Ground Classes | Best Pilot Training Institute in India | WeOne Aviation" description="India's best DGCA Ground Classes delivering 100% results every year. 3000+ pilots trained. CPL ground school covering all DGCA subjects. Join WeOne Aviation Academy.">
          ...
          <div className="lg:col-span-2">
            <ScrollReveal>
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-2">
                The Directorate General of Civil Aviation (DGCA) is the main government body that controls and regulates all aviation-related activities in India.
              </p>
              <p className="text-gray-600 text-sm leading-relaxed mb-2">
                It makes rules for flying, conducts DGCA exams, and issues pilot licenses.
              </p>
              <p className="text-gray-600 text-sm leading-relaxed mb-8">
                To become a pilot, you must follow DGCA regulations and clear DGCA exams.
              </p>
              ...
              {/* Why Important */}
              <h3 className="font-montserrat text-xl font-bold text-av-blue mb-3">Why Are DGCA Ground Classes Important for Pilot Training?</h3>
              ...
              {/* Subjects */}
              <h3 className="font-montserrat text-xl font-bold text-av-blue mb-2">Dgca Ground Classes Subjects For Dgca Exam</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-5">There Are Mainly 6 Subjects in DGCA Exam.</p>
              ...
              <h3 className="font-montserrat text-xl font-bold text-av-blue mt-10 mb-5">DGCA CPL Subjects, Syllabus and Topics (with Explanation)</h3>
              <div className="space-y-3 mb-10">
                {subjects.filter(s => s.detail).map((s) => (
                  <div key={s.num} className="flex gap-3 items-start text-sm text-gray-600">
                    <span className="flex-shrink-0 w-6 h-6 bg-av-orange rounded-full flex items-center justify-center text-white text-xs font-bold">{s.num}</span>
                    <div>
                      <p className="font-semibold text-av-blue mb-1">{s.title}</p>
              ...
              {/* Duration */}
              <h3 className="font-montserrat text-xl font-bold text-av-blue mb-3">Duration of DGCA Ground Classes</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-2">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-10">
                However, classes may be extended for students who do not clear exams on their first attempt.
              </p>

              {/* Eligibility */}
              <h3 className="font-montserrat text-xl font-bold text-av-blue mb-2">Eligibility for DGCA Ground Classes</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-5">
                To enroll in DGCA Ground Classes and begin your journey toward becoming a Commercial Pilot, you must meet the following eligibility criteria:
              </p>
              <div className="space-y-4 mb-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed mb-10">
                If you meet these requirements, you're ready! Join us to begin your journey with We One Aviation Academy – Delhi's trusted name for DGCA Ground Classes and Pilot Training.
              </p>

              {/* Why Choose */}
              <h3 className="font-montserrat text-xl font-bold text-av-blue mb-2">Why Choose We One Aviation Academy For Dgca Ground Classes</h3>
              <p className="text-gray-600 text-sm leading-relaxed mb-5">
