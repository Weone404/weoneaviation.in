...
export default function PilotTrainingGurugram() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Gurugram – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Gurugram students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Gurugram with Placement Assistance',
            }}
