...
const sitemapData = [
    ...
    },
    {
        ...
        links: [
            ...
            { label: 'PPL Course Fees', href: '/ppl-full-form' },
            { label: 'ATPL (Advanced)', href: '/courses/atpl' },
            { label: 'Advanced ATPL Pilot Training', href: '/courses/atpl' },
        ],
    },
    {
        ...
        links: [
            ...
            { label: 'Pilot Training in Sri Lanka', href: '/pilot-training-in-sri-lanka' },
        ],
    },
    {
    ...
    },
    {
        ...
        links: [
            ...
            { label: 'Air India Cadet Pilot Program', href: '/airindia-pilot-preparation' },
            { label: 'IndiGo Cadet Pilot Program', href: '/indigo-pilot-preparation' },
        ],
    },
    {
            ...
            <div className="bg-gradient-to-r from-av-blue to-av-navy py-14 px-4 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-white/70 text-sm">
                        Browse all pages of We One Aviation Academy — DGCA pilot training institute
                    </p>
                    {/* Breadcrumb */}
