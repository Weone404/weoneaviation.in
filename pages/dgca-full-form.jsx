...
export default function DGCAPage() {
    return (
        <Layout
            title="DGCA Full Form: What Is DGCA in Aviation? | WeOne Aviation"
            description="DGCA full form is Directorate General of Civil Aviation. Learn what DGCA does — its role in pilot licensing, aircraft certification and aviation safety in India."
        >
