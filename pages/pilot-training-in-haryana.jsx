...
export default function PilotTrainingHaryana() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Haryana – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Haryana students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Haryana with Placement Assistance',
            }}
