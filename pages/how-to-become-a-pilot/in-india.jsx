...
export default function InIndia() {
  return (
    <Layout title="How to Become a Pilot in India – DGCA Guide" description="Complete guide on becoming a commercial pilot in India. DGCA requirements, CPL eligibility, flying schools, fees, career prospects and salary in 2024.">
      {/* Hero */}
