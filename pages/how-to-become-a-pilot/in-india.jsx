...
const pilotSteps = [
  ...
  { title: 'Book your DGCA medical before you spend anything else', desc: 'A DGCA examiner checks that you meet the fitness standards the licence requires. Do this first. Finding a disqualifying condition after paying a flying-school deposit is the most expensive mistake in the process, and it is entirely avoidable.' },
