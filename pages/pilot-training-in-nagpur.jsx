...
export default function PilotTrainingNagpur() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Nagpur – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Nagpur students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Nagpur with Placement Assistance',
            }}
