...
export default function PilotTrainingMaharashtra() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Maharashtra – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Maharashtra students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Maharashtra with Placement Assistance',
            }}
