...
export default function PilotTrainingGujarat() {
    return (
        <CityPageTemplate
            city="Gujarat"
            ...
            hero={{
                ...
                sub: 'CPL, PPL and DGCA ground classes in Gujarat',
            }}

            intro={`Gujarat students often balance strong industrial careers and family commitments with a need for focused, logistically simple pilot training. Ahmedabad (AMD) and Vadodara (BDQ) are the state’s main aviation anchors, while Surat and Rajkot are important feeder cities whose students must carefully plan travel for flying hours and DGCA exams. This page is written to be a practical planning guide: where to book simulator slots, which local flying clubs accept short practice blocks, and how to minimise travel and accommodation costs when attending DGCA Pariksha sessions.

        Local training options: In Gujarat, many students combine weekday ground classes in Ahmedabad with intensive flying blocks at quieter satellite fields during long weekends. We identify local institutions that provide circuit training and hour-building, outline approximate price ranges for simulator sessions in Ahmedabad and Vadodara, and recommend booking strategies to avoid month-end scheduling conflicts.

        DGCA exam planning: Gujarat candidates commonly travel to Ahmedabad for DGCA exams; this page includes directions to the principal exam centre, recommended times to avoid road congestion, and a pre-exam checklist (medical certificate scans, identity documents, and exam confirmations). For students travelling from Surat or Rajkot, we recommend a one-night stay near the exam venue and a simulator session the day before the exam to consolidate revision.

        Regional career advice: We cover scholarship pointers for Gujarat families, advice on clustering ground-class days to reduce travel overhead, and case-study notes from recent students about timing, accommodation choices, and how to successfully combine local work or study with high-quality pilot training.`}
            ...
            courses={[
                {
                    ...
                    desc: 'Want to fly massive planes for big airlines? Our CPL program at the Pilot Training Institute in Gujarat is your ticket to the cockpit. Our pro instructors — real pilots with real experience — teach you to handle everything like a champ. Soon, you\'ll be landing jobs with the coolest airlines!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Want to fly around for fun? Our PPL program at the Pilot Training Institute in Gujarat is just right for you. Take your friends up in the sky or chill above the city — we keep it simple and exciting. Fly by yourself, however you like!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Our DGCA Ground Classes at the Pilot Training Institute in Gujarat make it super easy to learn air navigation, meteorology, and air regulations — all approved by DGCA. Crack your DGCA exams without any tension with We One Aviation Academy!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Improve your flying skills with advanced aircraft training at our Pilot Training Institute in Gujarat. Designed for pilots who want to enhance their abilities and qualify for commercial aviation roles.',
                    details: [
            ...
            career={{
                intro: 'Gujarat is a major aviation center in India with great job options for trained pilots. Once you finish your training, you can try for jobs like these:',
                options: [
            ...
            syllabus={[
                { num: '1', title: 'Air Regulations', desc: 'The rulebook for flying — covers all the laws and guidelines pilots must follow, including airspace rules and safety standards. The "traffic rules" of the sky over Gujarat and beyond.' },
                ...
                { num: '3', title: 'Air Navigation', desc: 'Your GPS guide to flying! Learn how to find your way using maps, instruments, and calculations — from Gujarat to Mumbai or anywhere across India and beyond.' },
            ...
            fees={{
                ...
                whyChanges: [
                    ...
                    { title: 'City & Location (Gujarat)', desc: 'Gujarat\'s city environment means pilot training costs are slightly higher compared to smaller towns.' },
