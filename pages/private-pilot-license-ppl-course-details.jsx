...
export default function PPL() {
  return (
    <CoursePageTemplate
      meta={{ title: 'Private Pilot License (PPL) Training in India | We One Aviation', description: 'Get your PPL from India\'s top DGCA-approved aviation academy. Learn to fly with expert instructors. Eligibility, fees, and duration details inside.' }}
      ...
      career={{ text: 'PPL opens doors to CPL and airline career. Pay varies by airline and experience.', salary: 'Varies by airline and experience', salaryLabel: 'First Officer at airlines' }}
    />
  );
}
