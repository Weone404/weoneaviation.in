...
export default function PilotTrainingPunjab() {
    return (
        <CityPageTemplate
            city="Punjab"

            meta={{
                title: 'Pilot Training in Punjab – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Punjab students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Punjab with Placement Assistance',
            }}

            intro="Are you dreaming of a career in aviation? Our World Class Pilot Training Institute in Punjab is best for you if you want to become a pilot — whether you are looking for Commercial Pilot Training, Private Pilot Training or aiming to become an airline captain. We provide all types of Pilot Training with experienced flight instructors and the latest technology available at our academy. Punjab, with Chandigarh as its aviation hub, is a growing center for aviation in North India — creating a high demand for trained pilots, and we are here to train the next generation of aviation professionals."
            ...
            courses={[
                {
                    ...
                    desc: 'Want to fly massive planes for big airlines? Our CPL program at the Pilot Training Institute in Punjab is your ticket to the cockpit. Our pro instructors — real pilots with real experience — teach you to handle everything like a champ. Soon, you\'ll be landing jobs with the coolest airlines!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Want to fly around for fun? Our PPL program at the Pilot Training Institute in Punjab is just right for you. Take your friends up in the sky or chill above the city — we keep it simple and exciting. Fly by yourself, however you like!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Our DGCA Ground Classes at the Pilot Training Institute in Punjab make it super easy to learn air navigation, meteorology, and air regulations — all approved by DGCA. Crack your DGCA exams without any tension with We One Aviation Academy!',
                    details: [
                ...
                },
                {
                    ...
                    desc: 'Improve your flying skills with advanced aircraft training at our Pilot Training Institute in Punjab. Designed for pilots who want to enhance their abilities and qualify for commercial aviation roles.',
                    details: [
            ...
            career={{
                intro: 'Punjab, with Chandigarh as a key aviation center, offers great job options for trained pilots in North India. Once you finish your training, you can try for jobs like these:',
                options: [
            ...
            syllabus={[
                { num: '1', title: 'Air Regulations', desc: 'The rulebook for flying — covers all the laws and guidelines pilots must follow, including airspace rules and safety standards. The "traffic rules" of the sky over Punjab and beyond.' },
                ...
                { num: '3', title: 'Air Navigation', desc: 'Your GPS guide to flying! Learn how to find your way using maps, instruments, and calculations — from Punjab to Delhi or anywhere across India and beyond.' },
            ...
            fees={{
                ...
                whyChanges: [
                    ...
                    { title: 'City & Location (Punjab)', desc: 'Punjab\'s city environment, including Chandigarh, means pilot training costs are slightly higher compared to smaller towns.' },
            ...
            faqs={[
                { q: 'How long does it take to complete pilot training in Punjab?', a: 'PPL takes 4-6 months, CPL takes 12-18 months, and ATPL requires additional experience after CPL. DGCA Ground Classes take 3-6 months.' },
                { q: 'What are the fees for pilot training in Punjab?', a: 'The average fees for CPL training in Punjab is INR 40–50 Lakh. This includes ground classes (INR 2-5 lakhs), 200 hours of flying (INR 35-45 lakhs), simulator training (INR 3-5 lakhs), and extra gear (INR 1-2 lakhs). WeOne Aviation provides scholarship and flexible payment options.' },
                { q: 'What is the eligibility to become a pilot in Punjab?', a: 'Minimum age of 17 years, 10+2 with Physics & Mathematics, DGCA Class 1 & Class 2 Medical clearance, and English proficiency are required.' },
                { q: 'Does WeOne Aviation provide placement assistance in Punjab?', a: 'Yes! We provide Placement Assistance. Our graduates have successfully joined major airlines, cargo operations, and private aviation companies worldwide.' },
                { q: 'Can I get a scholarship for pilot training in Punjab?', a: 'Yes! WeOne Aviation Academy provides scholarships to every deserving student along with a flexible fees structure and loan assistance to make pilot training affordable.' },
                { q: 'What career options are available after pilot training in Punjab?', a: 'After completing pilot training, you can work as a Commercial Airline Pilot (IndiGo, Air India, SpiceJet), Private Pilot, Cargo Pilot (FedEx, Blue Dart), Flight Instructor, or Charter Pilot. Punjab\'s growing aviation sector with Chandigarh as a key hub creates excellent demand for trained pilots.' },
            ]}
        />
    );
}