...
export default function PilotTrainingRajasthan() {
  return (
    <CityPageTemplate
      ...
      meta={{
        title: 'Pilot Training in Rajasthan – CPL, PPL & DGCA | WeOne',
        description: 'DGCA-approved pilot training for Rajasthan students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
      }}
      ...
      hero={{
        ...
        sub: 'World-class CPL, PPL & DGCA Ground Classes in Rajasthan with Placement Assistance',
      }}
