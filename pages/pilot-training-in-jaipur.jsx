...
export default function PilotTrainingJaipur() {
    return (
        <CityPageTemplate
            ...
            meta={{
                title: 'Pilot Training in Jaipur – CPL, PPL & DGCA | WeOne',
                description: 'DGCA-approved pilot training for Jaipur students at WeOne Aviation: CPL, PPL & ground classes, scholarships and placement support.',
            }}
            ...
            hero={{
                ...
                sub: 'World-class CPL, PPL & DGCA Ground Classes in Jaipur with Placement Assistance',
            }}
