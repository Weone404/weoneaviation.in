...
const faqs = [
  ...
  { q: 'What medical do I need for the flying phase?', a: `A Class 2 medical to begin flight training, and a Class 1 for the Commercial Pilot Licence itself. ${MED.timingAdvice}` },
