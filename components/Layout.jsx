...
export default function Layout({ children, title, description, keywords, robots, noindex = false, canonical }) {
  ...
  // `canonical` prop overrides the self-referencing URL — used to point a duplicate page at its primary version
  const canonicalUrl = canonical || `https://www.weoneaviation.in${canonicalPath === '/' ? '/' : canonicalPath}`;
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={description || "WeOne Aviation Academy offers DGCA approved pilot training courses including CPL, PPL, ATPL in India. Join India's trusted aviation training institute."} />
