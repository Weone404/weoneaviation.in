...
export const EGCA = {
  ...
  epl: {
    ...
    what: 'A secure digital licence carrying security features aligned with ICAO standards, meant to establish authenticity, prevent tampering and allow verification in real time.',
 ...
 *
 * ✅ REVISION 7 READ IN FULL — 2026-09-16.
 *   The owner supplied the DGCA-issued PDF of Series 'C' Part I, Issue II of
 *   12.10.2017, at Revision 7 dated 01 October 2025, effective 15 November
 *   2025, F. No. AV 22025/32/DMS/Med. Every figure below has been re-read
 *   against that text, together with two companion CARs supplied the same day:
 *     Series 'C' Part III, Issue I of 23.06.2017, Rev. 1 dated 08 October 2025
 *       — Empanelment of Medical Examiner for Conduct of Class 1 Medical
 *       Examination.
 *     Series 'C' Part IV, Issue I of 25.01.2019, Rev. 1 dated 07 October 2025
 *       — Empanelment of Medical Examiner for Conduct of Class 2 Medical
 *       Examination, whose Appendix 'A' carries the Class 2 investigation list.
 *
 *   WHAT CHANGED AGAINST THE Rev. 6 READING. The three validity bands are
 *   unchanged and now confirmed against the current revision. What was missing
 *   is the initial-issue restriction: an initial Class 1 may not be done at any
 *   empanelled examiner, only at AFCME, IAM, MEC (East) or a DGCA-empanelled
 *   Aeromedical Evaluation Centre. The fees, the eGCA booking step, the NOC
 *   window, the appeal window, the limitation wording and the Class 2
 *   investigation table are all new, and all come from the three documents.
 *
 * ⚠ THE EYESIGHT QUESTION, ANSWERED HONESTLY.
 *   Revision 7 publishes NO numeric vision standard. Not 6/6, not a dioptre
 *   limit, not a colour-vision threshold. Paragraphs 2.2(d), 2.4.1(b), 2.4.2(b)
 *   and 2.4.3(b) adopt ICAO Annex 1, Chapter 6 — paras 6.2.2 to 6.2.5 for all
 *   classes, then 6.3.2/6.3.3/6.3.4 for Class 1, 6.4.2/6.4.3/6.4.4 for Class 2
 *   and 6.5.2/6.5.3/6.5.4 for Class 3 — and add the AICs (Medical) on the DGCA
 *   website. So an eyesight page that quotes a number and attributes it to the
 *   CAR is quoting something the CAR does not say. The numbers live in ICAO
 *   Annex 1 and in the AICs; until one of those is read in full, this site
 *   states where the standard comes from and does not invent the figure.
 *
 *   CAR Section 7, Series 'C', Part I, Issue II dated 12 October 2017,
 *   Revision 7 dated 01 October 2025, effective 15 November 2025 —
 *   "Medical Requirements and Examination for Flight Crew / Air Traffic
 *   Controller Licences and Ratings". Read from the DGCA-issued PDF.
 *
 ...
 *   Appendix 'B' of the CAR itself no longer prints the examiner lists at all —
 *   it points to the DGCA website, which is why the S3 list stays a separate
 *   source with its own date.
 *
...
export const MEDICAL_STANDARDS = {
  ...
  car: {
    citation:
      "Civil Aviation Requirement, Section 7 — Flight Crew Standards, Training and Licensing, Series 'C', Part I, Issue II dated 12 October 2017, Revision 7 dated 01 October 2025",
    effectiveFrom: '15 November 2025',
    fileNumber: 'F. No. AV 22025/32/DMS/Med',
    title: 'Medical Requirements and Examination for Flight Crew / Air Traffic Controller Licences and Ratings',
    issuedUnder: 'Rule 133A of the Aircraft Rules, 1937.',
  },
  rules: {
    ...
    validity39C: 'Rule 39C lays down the validity of the medical for pilots. It was amended on 27 December 2019 to raise the age limit for the validity of the Class 1 medical examination from forty years to sixty.',
    atco: 'Rules 103 and 104 do the same job for air traffic controllers — rule 103 requires a Medical Assessment issued by the Director-General, rule 104 sets its period of validity.',
  },
  ...
  classes: [
    {
      ...
      validity: 'One year up to the age of 60, and six-monthly thereafter. For single-crew operations, six-monthly above the age of 40.',
      conductedBy: 'Medical boards at Indian Air Force medical centres, civil medical centres, and DGCA-empanelled Class 1 medical examiners — but the initial issue is restricted to the centres listed separately below.',
      icaoParas: 'ICAO Annex 1, paragraphs 6.3.2 (physical and mental), 6.3.3 (visual) and 6.3.4 (hearing).',
    },
    {
      cls: 'Class 2',
      licences: [
        ...
        'Flight Radio Telephone Operator Licence, and the restricted variant',
      ],
      validity: 'Two years up to the age of 50, and one year thereafter.',
      conductedBy: 'Any DGCA-empanelled Class 1 medical examiner, and DGCA-empanelled Class 2 medical examiners holding an MBBS, registered with the Medical Council of India, who have completed the approved training in aviation or aerospace medicine at IAM, Bengaluru.',
      icaoParas: 'ICAO Annex 1, paragraphs 6.4.2, 6.4.3 and 6.4.4.',
    },
    {
      cls: 'Class 3',
      licences: ['Student Air Traffic Controller Licence', 'Air Traffic Controller Licence'],
      validity: 'Four years up to the age of 40, two years above 40 and up to 50, and one year above 50.',
      conductedBy: 'The initial examination is carried out by DGCA-empanelled Class 1 medical examiners. Renewals are carried out by DGCA-empanelled Class 3 medical examiners, a group that includes Class 1 and Class 2 examiners — a Class 2 examiner needs more than three years of experience to become a Class 3 examiner.',
      icaoParas: 'ICAO Annex 1, paragraphs 6.5.2, 6.5.3 and 6.5.4.',
    },
  ],
  ...
  examination: {
    ...
    standardsFrom:
      'The standards are those of ICAO Annex 1, Chapter 6. Paragraphs 6.2.2 to 6.2.5 apply to every class, and each class then has its own physical, visual and hearing paragraphs. The requirements in the AICs (Medical) published on the DGCA website apply in addition.',
    noNumbersInCar:
      'The CAR itself publishes no numeric vision, colour-perception or hearing figure. It adopts the ICAO Annex 1 standards and the AICs by reference. Any page quoting a specific eyesight number and crediting it to this CAR is crediting it to a document that does not contain it.',
    freeFrom: [
      'Any abnormality, congenital or acquired',
      'Any active, latent, acute or chronic disability',
      'Any wound, injury or sequela from an operation',
      'Any effect or side-effect of medication taken',
    ],
    freeFromQualifier:
      'The CAR qualifies that list: what disqualifies is a degree of functional incapacity likely to interfere with the safe operation of an aircraft or the safe performance of duties. It is not a list of conditions that automatically end a career.',
  ...
  /** How a candidate actually starts. This is the step most pages leave out. */
  process: {
    booking: 'The applicant books the appointment on the eGCA module, for the intended DGCA-empanelled examination centre or examiner.',
    forms: [
      'CA-34 — the examination form for an initial issue, where details are filled in on paper',
      'CA-34A — the same, for a renewal',
      'CA-35 — the medical certificate of fitness, a copy of which is handed to the candidate',
      "Appendix 'A' of the CAR — the Medical Assessment itself, issued by DGCA",
    ],
    formsNote:
      'Where the examination is filled online instead, the checks and the medical declaration are completed on the eGCA portal and the investigation reports are uploaded there by the applicant, then validated by the examiner.',
    declaration: [
      'Whether they have previously undergone such an examination, and with what result',
      'Any period of sickness, injury or surgical procedure since the last examination',
      'Whether they are taking any drug or are on medication',
    ],
    falseDeclaration:
      'A false declaration to a medical examiner is treated as a serious lapse. The examiner reports it to DGCA by email within one week for penal action.',
    idCheck: 'Every laboratory report must carry an ID-verified endorsement — a driving licence, voter ID or passport number. The examiner checks this before validating.',
    confidentiality: 'Medical confidentiality is to be respected at all times, with records held securely and access restricted to authorised personnel.',
  },

  /** The statutory fee, which is a DGCA charge and not an academy charge. */
  fees: {
    note: 'Payable before the examination at the Indian Air Force centres, on the Bharatkosh portal.',
    portal: 'https://bharatkosh.gov.in',
    rows: [
      { cls: 'Class 1', purpose: 'Initial issue of licence', amount: 5000, label: '₹5,000' },
      { cls: 'Class 1', purpose: 'Renewal of licence', amount: 5000, label: '₹5,000' },
      { cls: 'Class 2 / Class 3', purpose: 'Initial issue of licence', amount: 3000, label: '₹3,000' },
      { cls: 'Class 2 / Class 3', purpose: 'Renewal of licence', amount: 3000, label: '₹3,000' },
    ],
    investigationCharges: 'Investigation charges at the IAF boarding centres are separate, and follow FCL Circular 03 of 2025.',
    privateExaminers:
      'The fee above is the IAF-centre fee. A DGCA-empanelled Class 2 medical examiner in private practice may collect reasonable charges of their own, and the laboratory is paid separately by the applicant. Ask the examiner what the total comes to before booking.',
  },

  /** The order of the two medicals, which is the question candidates get wrong. */
  classOrder: {
    notMandatory:
      'A Class 2 Medical Assessment is not a prerequisite for sitting the Class 1 initial examination. The CAR states the Class 2 assessment is issued for licensing purposes, Class 2 renewals, re-initials and temporary or permanent unfit cases.',
    ifYouDoClass2First:
      'Where a Class 2 is done first, the Class 1 initial may be conducted on the basis of a fit CA-35 from it, and a minimum of one month should separate the initial Class 2 from the Class 1.',
    investigationsRepeat:
      'Investigations are repeated in full at the Class 1 examination whatever was done at Class 2. Only radiological investigations from the Class 2 may be accepted, at the centre’s discretion, if they were carried out within the last two months.',
    advice:
      'Book the Class 1 initial before committing money to a flying school. The student pilot licence only needs a Class 2, but the licence you are training towards needs a Class 1 — and finding a disqualifying condition after paying a deposit is an expensive way to learn it.',
  },

  /** What the Class 2 examination actually involves, by age band. */
  class2Investigations: {
    citation: "CAR Section 7, Series 'C', Part IV, Issue I dated 25 January 2019, Rev. 1 dated 07 October 2025, Appendix 'A'",
    rows: [
      { when: 'Initial examination', tests: 'Blood Hb%, TLC, DLC; Urine RE/ME; ECG (R); Chest X-ray PA view; Pure Tone Audiometry' },
      { when: 'Renewal before 40', tests: 'Blood Hb%, TLC, DLC; Urine RE/ME' },
      { when: 'Renewal, 40 to 49', tests: 'Blood Hb%, TLC, DLC; Urine RE/ME. ECG (R) and Pure Tone Audiometry every five years' },
      { when: 'Renewal, 50 to 59', tests: 'Blood Hb%, TLC, DLC; Urine RE/ME. ECG (R) and Pure Tone Audiometry every two years' },
      { when: 'At 40, 45, 50 and 55', tests: 'Blood Hb%, TLC, DLC; Urine RE/ME; fasting and post-prandial blood sugar; lipid profile; ECG (R); Pure Tone Audiometry' },
      { when: 'Renewal at and after 60', tests: 'The 40-to-55 panel, plus HbA1c and blood sugar two-yearly, PSA, USG abdomen, chest X-ray PA view, and a TMT at 60 and every five years after' },
    ],
    additional: 'Additional tests may be requested on what the clinical examination finds. Tests are done at NABL or NABH accredited laboratories, or at the DGCA-approved Air Force Class 1 centres.',
  },

  /** The four outcomes, and what a limitation means in practice. */
  disposition: {
    outcomes: ['Fit', 'Fit with limitations', 'Temporary unfit', 'Permanent unfit'],
    limitations: ['Fit to fly as co-pilot only — not applicable to a student pilot licence holder', 'Fit to fly as pilot-in-command along with a qualified experienced pilot'],
    experiencedPilot: [
      'Has no restrictions of their own due to medical conditions',
      'Holds a P2 type endorsement',
      'Has a minimum of 100 hours of experience on the type and is currently flying it',
    ],
    dateRule: 'The date of the Medical Assessment issued by DGCA is reckoned from the date of the medical examination on the CA-35.',
    grounded: 'A pilot or controller declared unfit on a CA-35 carries out no duties until a satisfactory final assessment is issued by the office of the DGCA.',
  },

  /** NOC and the timing windows, which decide whether a renewal is straightforward. */
  timing: {
    window:
      'A licence holder may undergo the examination up to 45 days before the expiry of the last medical, or up to 45 days after it, without a No Objection Certificate.',
    nocWhen:
      'An NOC is required only for a delayed, early, post-temporary-unfit or special examination that has a medical cause. It is applied for at least one week before the intended date, with the previous assessment and supporting documents attached.',
    minorIllness:
      'No NOC is needed for unfitness from minor illness of up to 30 days. Up to 15 days is reviewed by Class 1 examiners, airline aerospace medicine specialists or an airline doctor with Class 1 or Class 2 certification; 15 to 30 days needs formal written sanction from DMS (CA); beyond 30 days a special medical examination is applied for through NOC services on eGCA.',
    earlyReview:
      'A temporary unfit case that has recovered may apply for an early medical through NOC once at least half the recommended period has elapsed. Sanction is case by case.',
    renewalVenue:
      'Ordinary yearly renewals are to be avoided at IAF boarding centres unless the last assessment recommended one. They are conducted at IAF renewal centres, DGCA-empanelled Class 1 medical examiners and aeromedical evaluation centres.',
  },

  /** The appeal route, which almost no Indian page states correctly. */
  appeal: {
    trigger: 'Available to a licence holder declared temporarily unfit for more than three months, at a stretch or in aggregate, or permanently unfit.',
    window: 'Within 90 days of the date of being declared permanently or temporarily unfit.',
    how: 'Processed on the eGCA module, or sent by registered email, post, speed post, courier, or delivered in person to the Receipt and Dispatch Section at DGCA.',
    documents: [
      'Original documents from reputed medical institutions or specialists certifying fitness status and the cause of the unfitness stated in the assessment, with sound reasons for the opinion',
      'Original reports of the examination and investigations conducted by that practitioner or specialist',
    ],
    venue: 'If the review is accepted it is carried out at the centre specified. For permanently unfit cases it is not done at the centre where the applicant was first declared unfit.',
    finality: 'The decision of DMS (CA) or DGMS (Air) on behalf of DGCA is final. DGCA may also reject an appeal it does not find justified.',
    permanentUnfit:
      'Permanent unfitness is recommended only by the medical board at an IAF boarding centre, after evaluation by specialists and specialised investigations, and is approved either by a board of officers at DGCA with DMS (CA) as president or by DGMS (Air).',
  },

  /**
   * The approved centres. Two lists with two different provenances: the
   * Air Force centres are printed in Appendix 'B' of the CAR itself; the
   * civil centres come from the DGCA list on the date in centresAsOf, because
   * Appendix 'B' no longer prints them.
   */
  centres: {
    initialIssueOnly: {
      note: 'An initial Class 1, a re-initial after the medical has lapsed more than two years, a post-temporary-unfit review and a special examination after more than 30 days of unfitness are restricted to these.',
      list: [
        'AFCME, New Delhi',
        'IAM, Bengaluru',
        'MEC (East), Jorhat',
      ...
      appealNote: 'An appeal medical examination is narrower still — AFCME, IAM or MEC (East) only.',
      fiveYearly:
        'The same four apply to the five-yearly renewal from the age of 45 up to 60, and to every examination after 60. After 60, a candidate given a fit disposal at the last examination may take every alternate examination at a DGCA-empanelled Class 1 medical examiner.',
      routine:
        'The periodic examinations at 25, 30, 35 and 40, and other Class 1 renewals, may be done at any IAF renewal or boarding centre, at an aeromedical evaluation centre, or with a Class 1 medical examiner.',
    },
    boardingCentres: [
      { name: 'Air Force Central Medical Establishment (AFCME), Subroto Park', city: 'New Delhi' },
      { name: 'Institute of Aerospace Medicine, Vimanpura', city: 'Bengaluru' },
      { name: 'Medical Evaluation Centre (East), 5 Air Force Hospital', city: 'Jorhat, Assam' },
    ],
    airForceOther: [
      'Air Force Station Palam, New Delhi',
      'No. 1 Aeromedical Training Centre, Air Force Station Hindan, Ghaziabad',
      'Air Force Station Rajokri, New Delhi',
      '54 ASP, Air Force Station, Gurugram',
      'Air Force Station Agra',
      'Air Force Station Chakeri, Kanpur',
      'Air Force Station Cotton Green, Mumbai',
      'Air Force Station Lohegaon, Pune',
      'Air Force Station Thane, Mumbai',
      'Air Force Station Tambaram, Chennai',
      'Air Force Station Yelahanka, Bengaluru',
      'Air Force Station Begumpet, Secunderabad',
      'Air Force Station Hakimpet, Secunderabad',
      'Air Force Station Chandigarh',
      'Air Force Station Barrackpore, Kolkata',
      'HQ SAC (U) IAF, Akkulam, Thiruvananthapuram',
      'SMC, HQ SWAC (U) IAF, Chiloda, Gandhinagar',
    ],
    airForceNote:
      "Appendix 'B' of the CAR lists twenty Air Force medical examination centres. The first three are the boarding centres; the rest are Senior Medical Officer stations used for renewals.",
    civil: [
    ...
    listNote:
      'DGCA updates the aeromedical evaluation centre and examiner lists on its website and they are no longer printed in the CAR. Check the current version before travelling to a centre.',

    /*
     * DGCA's own count, from the list updated 27 August 2026. Quote these
     * figures rather than counting our arrays: the arrays are a subset we
     * transcribed, the figures are what DGCA states on the document.
     */
    dgcaCounts: {
      class1Exam: 'Class 1 medical examinations are conducted at thirteen centres — three Indian Air Force boarding centres and ten DGCA-approved aeromedical evaluation centres.',
      class1Renewal: 'Class 1 renewal examinations are conducted at eighteen centres of the Indian Air Force and by fifty-five DGCA-empanelled Class 1 medical examiners.',
      asOf: '27 August 2026',
    },

    /*
     * Local fact, and a genuinely useful one for a Dwarka academy: DGCA's
     * Class 1 examiner list carries four examiners with addresses in Dwarka
     * itself, in sectors 6, 9, 14 and 19, plus one at Delhi International
     * Airport. We do not print their names, addresses or personal mobile
     * numbers. They are private practitioners, the empanelment dates move,
     * and a stale directory of someone's mobile number on a commercial site
     * is a liability, not a service. The count and the link are the service.
     */
    dwarka: {
      class1Examiners: 4,
      sectors: ['6', '9', '14', '19'],
      airport: 'One more is listed at Delhi International Airport Ltd, New Udaan Bhawan.',
      note: 'Named, with contact details and empanelment validity, in the DGCA list linked in the sources. We have no association with any of them.',
    },

    /*
     * ⚠ A REAL WARNING, CHECKED 2026-09-17, NOT AN ACCUSATION.
     * Every empanelment validity date printed in DGCA's published Class 2
     * examiner list has already passed — the latest is 1 February 2026, and
     * the list was read on 17 September 2026. The Class 1 list is current by
     * contrast: its entries run to 2029. So the Class 2 list should be
     * treated as a directory of who has been empanelled, not proof of who is
     * empanelled today. Re-check this before publishing it again; if DGCA
     * refreshes the file the warning has to come down.
     */
    class2ListCaution:
      "Every empanelment validity date printed in DGCA's published Class 2 examiner list has already passed — the most recent runs to 1 February 2026, and the list was read on 17 September 2026. Treat it as a record of who has been empanelled rather than proof of who is empanelled today, and confirm current empanelment with the examiner, or with the DGCA Medical Directorate, before paying for anything.",
    class2ListStructure:
      'The Class 2 list is organised by region — Northern, Southern, Western and Eastern — and prints each examiner\u2019s name, address, contact details and the date their empanelment runs to.',
  },

  /**
   * Who is allowed to call themselves a DGCA medical examiner. Kept here
   * deliberately: it is the test any such claim on this site has to pass.
   */
  examinerRequirements: {
    class1: {
      citation: "CAR Section 7, Series 'C', Part III, Issue I dated 23 June 2017, Rev. 1 dated 08 October 2025",
      qualification:
        'A post-graduate degree in aviation medicine. A waiver may be granted at the discretion of the DG (CA) for a post-graduate degree in medicine with a minimum of two months of formal training in primary aviation medicine at the Institute of Aerospace Medicine, Bengaluru — only where the area is remote, no empanelled Class 1 examiner is available nearby, DGCA has assessed a requirement there, and the applicant has five years of experience as a DGCA Class 2 medical examiner.',
      other: [
        'Registered with the Medical Council of India or a State Medical Council',
        'Holds the infrastructure and facility to conduct the examination, with NABL-accredited laboratories where laboratories are co-opted',
        'Selected through a professional interview before a DGCA board, followed by an inspection of the medical facility within two months',
        'Permitted to operate from one medical facility only, with one additional aeromedical evaluation centre panel at DGCA discretion',
      ],
    },
    class2: {
      citation: "CAR Section 7, Series 'C', Part IV, Issue I dated 25 January 2019, Rev. 1 dated 07 October 2025",
      qualification: 'MBBS, with a minimum of two weeks of training in aviation medicine at IAM, IAF Bengaluru, and registration with the Medical Council of India or a State Medical Council.',
      other: [
        'Empanelled for three years, extendable by three years at a time after re-assessment',
        'Must have attended at least one physical and two e-workshops conducted by DGCA in the last three years to be extended',
        'A female attendant must be present during the examination of every female candidate',
        'Capped at 10 to 12 medical examinations a day and 250 a month, all types included',
      ],
      penalties:
        'DGCA grades non-compliance in three levels — a warning for unintentional errors, temporary suspension for repeated or significant ones, and permanent suspension for intentional malpractice or two temporary suspensions in a three-year cycle.',
    },
    whyItMatters:
      'Empanelment is a DGCA process with a published qualification bar, an interview and a facility inspection. It is verifiable — the empanelled lists are published by DGCA and linked in the sources below, name by name. Nobody should describe themselves as a DGCA medical examiner on the strength of anything less, and anybody can check a claim in about a minute.',
  },
  ...
  sources: [
    ...
    { label: "CAR Section 7, Series 'C', Part I, Issue II 12 October 2017, Rev. 7 dated 01 October 2025, effective 15 November 2025 — Medical Requirements and Examination for Flight Crew / Air Traffic Controller Licences and Ratings", url: 'https://www.dgca.gov.in/digigov-portal/?dynamicPage=civilAviationRequirements%2F6%2F0%2FviewDynamicRulesReq' },
    { label: "CAR Section 7, Series 'C', Part III, Issue I 23 June 2017, Rev. 1 dated 08 October 2025 — Empanelment of Medical Examiner for Conduct of Class 1 Medical Examination", url: 'https://www.dgca.gov.in/digigov-portal/?dynamicPage=civilAviationRequirements%2F6%2F0%2FviewDynamicRulesReq' },
    { label: "CAR Section 7, Series 'C', Part IV, Issue I 25 January 2019, Rev. 1 dated 07 October 2025 — Empanelment of Medical Examiner for Conduct of Class 2 Medical Examination", url: 'https://www.dgca.gov.in/digigov-portal/?dynamicPage=civilAviationRequirements%2F6%2F0%2FviewDynamicRulesReq' },
    { label: 'List of DGCA approved aeromedical evaluation centres, Class 1 Air Force medical examination centres, IAF boarding centres and DGCA empanelled Class 1 examiners, updated 27 August 2026 (DGCA)', url: 'https://public-prd-dgca.s3.ap-south-1.amazonaws.com/InventoryList/personal/medical/class1/Class1.pdf' },
    { label: 'List of DGCA empanelled Class 2 medical examiners, by region, with empanelment validity (DGCA)', url: 'https://public-prd-dgca.s3.ap-south-1.amazonaws.com/InventoryList/personal/medical/class2/class2.pdf' },
    { label: 'List of DGCA empanelled civil Class 1 initial hospitals and Class 1 examiners, updated 02 March 2023 (DGCA)', url: 'https://public-prd-dgca.s3.ap-south-1.amazonaws.com/InventoryList/personal/medical/class1/c1exam.pdf' },
  ],
};
...
/*
 * ── FOREIGN_LICENCE: what it actually takes to convert a foreign licence ───
 *
 * WHY THIS EXISTS. Every "pilot training abroad" page in India — ours included,
 * until now — compares cost and weather and then says the licence is
 * "DGCA-recognised" or "convertible", as though conversion were a formality.
 * It is not a formality. It is a defined procedure with named examinations, a
 * skill test in India, a separate radio-telephony certificate from a different
 * ministry, and a currency test on the foreign rating. A reader who does not
 * know that budgets for a course and is then surprised by a second licensing
 * project after they get home.
 *
 * THE SOURCE. CAR Section 7 — Flight Crew Standards, Training and Licensing,
 * Series 'G', Part I, Issue II dated 01 July 2019, Revision 4 dated
 * 9 September 2019, F. No. AV-11012/5/2018-DTL-DGCA, "Requirements for issue
 * of Indian licences and aircraft ratings to pilots holding licences and
 * aircraft ratings issued by Contracting States". Issued under Rules 41 and
 * 133A of the Aircraft Rules, 1937.
 *
 * ⚠ PROVENANCE, STATED HONESTLY. This was read on 17 September 2026 from a
 * PDF of the DGCA-issued document hosted by a third party, because DGCA's own
 * CAR index is a JavaScript page whose deep links cannot be opened
 * programmatically. The document is internally consistent and carries its file
 * number, issue, revision, page footers and the Director General's name. It is
 * nevertheless a mirror, and there may be a revision after Rev. 4. BEFORE
 * treating any figure here as current, check DGCA's CAR index for a later
 * revision of Series 'G' Part I. If one exists, re-read it and update this
 * record and the verifiedOn date. Do not quietly relabel.
 *
 * WHAT NOT TO WRITE. No conversion fee and no conversion timeline. Rule 48 of
 * the Aircraft Rules sets the fees and we have not read the current schedule;
 * the timeline depends on examination sessions and examiner availability and
 * nobody publishes it. We do not offer conversion services, we do not have a
 * partner who does, and nothing built on this record may imply otherwise.
 */
export const FOREIGN_LICENCE = {
  verifiedOn: '2026-09-17',
  car: {
    citation:
      "Civil Aviation Requirement, Section 7 — Flight Crew Standards, Training and Licensing, Series 'G', Part I, Issue II dated 01 July 2019, Revision 4 dated 9 September 2019",
    fileNumber: 'F. No. AV-11012/5/2018-DTL-DGCA',
    title:
      'Requirements for issue of Indian licences and aircraft ratings to pilots holding licences and aircraft ratings issued by Contracting States',
    issuedUnder: 'Rules 41 and 133A of the Aircraft Rules, 1937.',
    provenanceNote:
      "Read from a PDF of the DGCA-issued document. Check DGCA's CAR index for a revision later than Rev. 4 before relying on it.",
  },

  why:
    'A licence issued by another country’s regulator is that country’s licence. It does not permit commercial flying on an Indian-registered aircraft. To fly commercially in India you apply to DGCA for an Indian licence on the basis of the foreign one, and that application has its own requirements.',

  /** The general bar, before any examination. */
  general: [
    'Age, as laid down in the relevant section of Schedule II of the Aircraft Rules, 1937',
    'Educational qualifications, as laid down in Schedule II',
    'Medical fitness — the Indian medical assessment of the appropriate class',
    'Flying experience and competency, as laid down in Schedule II',
  ],
  hoursShortfall:
    'If the country that issued the licence requires fewer flying hours than Schedule II does, the shortfall has to be completed — either in the State that issued the licence, or in India. A licence issued at a lower hour requirement does not lower the Indian requirement.',

  /** The examinations, by licence. This is the part nobody states correctly. */
  examinations: [
    {
      licence: 'Commercial Pilot Licence (aeroplane or helicopter)',
      papers: [
        'Air Regulations',
        'A composite paper for the Commercial Pilot Licence covering Air Navigation and Aviation Meteorology',
      ],
      note: 'Two written papers with the Central Examination Organisation — not the full Indian CPL paper set.',
    },
    {
      licence: 'Airline Transport Pilot Licence (aeroplane or helicopter)',
      papers: [
        'Air Regulations',
        'A composite paper for the Airline Transport Pilot Licence covering Air Navigation, Avionics (radio aids and instruments) and Aviation Meteorology',
      ],
      note: 'Plus an oral examination as stipulated in Schedule II, Section M or Section N, as the case may be.',
    },
    {
      licence: 'Private Pilot Licence, microlight, glider, balloon, light sport aircraft and gyroplane licences',
      papers: ['The examinations prescribed in the relevant section of Schedule II'],
      note: 'The full set for that licence, not a reduced conversion set.',
    },
  ],

  /** Everything after the papers. */
  skillTest:
    'The applicant demonstrates competency in a skill test on the type of aircraft the application relates to, to the satisfaction of a DGCA-approved examiner in India.',
  radioTelephony: [
    'A Certificate of Proficiency from the Ministry of Communications, under the Indian Wireless and Telegraphy Rules, 1954, for operating radio telephony apparatus on board an aircraft',
    'On that basis, DGCA issues a Flight Radio Telephone Operator licence under Section ‘Y’ of Schedule II',
    'A Signals (Practical) examination for the interpretation of signals, to the prescribed syllabus',
  ],
  radioNote:
    'This is the step people forget. The radio certificate comes from a different ministry, on its own timetable, and a commercial or airline transport conversion cannot complete without it.',

  /** The currency test on the foreign rating, and what happens if you fail it. */
  currency: {
    rule: 'The rating on the foreign licence has to be current for the type the conversion application relates to.',
    definition: [
      'At least 10 hours as pilot-in-command in the 24 months before the date of application — fifty per cent of co-pilot or dual time may be counted towards those 10 hours',
      'Or a flight review, check ride, flight test or skill test on the type in the same 24 months',
    ],
    where: 'That flying or that check has to be done in the State that issued the foreign licence.',
    ifNotCurrent: [
      'Pass the DGCA Technical Specific examination on the type',
      'Undergo endorsement training on the type, followed by skill tests',
    ],
    ifNotCurrentNote: 'Both in India, and both before the conversion application is made.',
  },

  /** Ratings, instructor ratings, and the paperwork rules. */
  ratings: {
    endorsement:
      'Only current ratings are considered for conversion, and the aircraft type has to be registered in India. Competency is demonstrated in skill tests by day and by night before a DGCA-approved examiner in India.',
    instrumentRating:
      'For an aircraft above 5,700 kg all-up weight the instrument rating skill test is carried out in India on forms CA40 and CA41; at or below 5,700 kg, on the instrument rating check proforma for that weight.',
    instructor:
      'A current flight instructor rating from a Contracting State can lead to an Assistant Flight Instructor or Flight Instructor rating on the Indian licence, subject to the flying experience in Schedule II Section ‘Q’ or ‘R’ and a competency demonstration before a DGCA-approved examiner or Flight Operations Inspector within the six months before applying.',
  },

  verification:
    'DGCA may verify the authenticity and validity of the documents with the aeronautical authority of the issuing State and with the training institute where the training was done.',
  falseDocuments:
    'A licence or rating obtained on incorrect information or false documents is liable to be cancelled, and the applicant is subject to action under the Aircraft Act, 1934, the Aircraft Rules, 1937 and the Indian Penal Code, 1860. The foreign licensing authority may be informed.',
  fees: 'Fees are those prescribed in Rule 48 of the Aircraft Rules, 1937. We do not publish a figure here because we have not read the current schedule.',
  applyTo: 'The application goes to DGCA, marked for the attention of the Director, Training and Licensing, with the documents required under Schedule II and this CAR.',

  sources: [
    { label: "CAR Section 7, Series 'G', Part I, Issue II 01 July 2019, Rev. 4 dated 9 September 2019 — Requirements for issue of Indian licences and aircraft ratings to pilots holding licences issued by Contracting States (DGCA)", url: 'https://www.dgca.gov.in/digigov-portal/?dynamicPage=civilAviationRequirements%2F6%2F0%2FviewDynamicRulesReq' },
    { label: 'Aircraft Rules, 1937 — rule 41 and Schedule II (DGCA)', url: 'https://www.dgca.gov.in/digigov-portal/?page=jsp/dgca/InventoryList/headerblock/aircraftRules/aircraftRules.html' },
  ],
};

/*
 * ── SRI_LANKA: the regulator, the school list, and the licence route ───────
 *
 * WHY THIS EXISTS. /pilot-training-in-sri-lanka existed since before this
 * campaign and was, on 17 September 2026, the last page on the site still
 * carrying the claim set the whole programme exists to remove: "DGCA
 * recognized", "200+ flight hours", "expert faculty", "affordable fees",
 * "proven placement success", and scholarships nobody could confirm. It also
 * addressed the wrong reader — it was written at Sri Lankan students, while the
 * query it ranks for is Indians asking whether to train in Sri Lanka.
 *
 * WHAT MAKES THE REBUILT PAGE WORTH READING. Two verifiable things nobody else
 * puts together: who the Sri Lankan regulator actually is and which schools it
 * lists, and precisely what DGCA then requires to turn a Sri Lankan licence
 * into an Indian one — which is FOREIGN_LICENCE above.
 *
 * SOURCES, both read on 17 September 2026 from the regulator's own site:
 *   Civil Aviation Authority of Sri Lanka, Training and Maintenance
 *   Organizations — "Current Status of Flying Training Organizations", the
 *   page last updated 5 February 2025, listing seven organisations, each
 *   linked to its own status document dated January 2025.
 *   Civil Aviation Authority of Sri Lanka, Commercial Pilot Licence (CPL)
 *   requirements page, last updated 23 December 2022.
 *
 * ⚠ WHAT WE DELIBERATELY DO NOT SAY. That any of the seven is "approved" today.
 * The CAASL page is titled "Current Status" and links a separate status
 * document per organisation precisely because status varies and changes. We
 * name the list, date it, and send the reader to the status document. We also
 * publish NO Sri Lankan flying-hour figure: that sits in CAASL Implementing
 * Standard 72, Appendix 3, which has not been read. The hour question is
 * answered from the Indian side instead, where we do have the rule.
 *
 * AND NO FEES. Not ours, not theirs, not "typical". We have no partnership
 * with any Sri Lankan school, we arrange nothing there, and the page says so.
 */
export const SRI_LANKA = {
  ...
  regulator: {
    ...
    note: 'CAASL is the licensing authority in Sri Lanka, the way DGCA is in India. A Sri Lankan licence is issued by CAASL, under Sri Lankan law, and is a foreign licence as far as India is concerned.',
  },
  ftoList: {
    asOf: '5 February 2025',
    statusDocsDated: 'January 2025',
    source: 'https://www.caa.lk/en/training-maintenance-organizations?id=279',
    names: [
      'Openskies Flight Training (Pvt) Ltd',
      'Asian Aviation Center (Pvt) Ltd',
      'Flysouthern (Pvt) Ltd',
      'Sakurai Aviation Academy',
      'Fits Air Flight Academy',
      'Red bird Aviation (Pvt) Ltd',
      'Lakwin Aviation (Pvt) Ltd',
    ],
    caution:
      'CAASL publishes this as the current status of flying training organisations, with a separate status document for each one, rather than as a flat list of approvals. Open the status document for the school you are considering, and check its date, before you send anyone money.',
  },

  /** CAASL's own published requirements for a Sri Lankan CPL. */
  cplRequirements: {
    asOf: '23 December 2022',
    items: [
      'Age not less than 18 years',
      'A CAASL Class 1 medical certificate',
      'A course completion letter from a CAASL-approved flying school, as required by Implementing Standard 72',
      'A CPL or ATPL theory examination completion result sheet issued by CAASL',
      'Flying experience as required by Implementing Standard 72, Appendix 3',
      'Flight instruction as required by Implementing Standard 72',
      'English Language Proficiency at Level 4 or higher',
      'A skill test report',
    ],
    governedBy: 'CAASL Implementing Standard 72 and the Personnel Licensing Procedures Manual, SLCAP 3010.',
    process:
      'The application is made through the CAASL computerised licensing system, then in person at the Training Organisation and Personnel Licensing section with the original logbook and documents. CAASL appoints the flight examiner; the skill test report goes back to the Director for processing.',
    licenceValidity:
      'A flight crew licence issued under Implementing Standard 72 is perpetual. Class and type ratings are separate: one year, except a single-pilot single-engine class rating, which is two years, unless the type certificate data sheet says otherwise.',
    hoursNote:
      'CAASL sets the flying-experience requirement in Implementing Standard 72, Appendix 3. We have not read that appendix and so publish no Sri Lankan hour figure here. The number that decides an Indian career is the Indian one, and that is in Schedule II.',
  },

  /** Why the honest version of this page is not a brochure. */
  forIndianStudents: {
    theRealQuestion:
      'The question is not whether Sri Lanka has flying schools. It does, and CAASL regulates them. The question is what a Sri Lankan licence is worth to someone who intends to fly for an Indian airline, and the answer is that it is a starting point for an Indian licence application, not a substitute for one.',
    whatWeDo:
      'We teach the DGCA ground subjects and we help candidates plan the route. We do not operate a flying school in Sri Lanka or anywhere else, we have no partnership with any of the organisations CAASL lists, we do not arrange admission there, and we earn nothing if you go.',
    whatToAsk: [
      'Which regulator issues the licence at the end of the course, and in which country?',
      'What are the total flying hours in the quote, and how do they compare with Schedule II of the Indian Aircraft Rules?',
      'If the hours fall short of Schedule II, where will the balance be flown, and at what rate?',
      'Is the instrument rating included, and on what aircraft weight category?',
      'Is the multi-engine endorsement included?',
      'What is refundable, on what notice, and under which country’s law is the contract enforceable?',
      'What visa does the training require, and what happens to it if the course overruns?',
      'Who pays for the conversion steps back in India, and are they in the quote at all?',
    ],
  },

  sources: [
    { label: 'Civil Aviation Authority of Sri Lanka — Current Status of Flying Training Organizations, page last updated 5 February 2025', url: 'https://www.caa.lk/en/training-maintenance-organizations?id=279' },
    { label: 'Civil Aviation Authority of Sri Lanka — Commercial Pilot Licence (CPL) requirements, last updated 23 December 2022', url: 'https://www.caa.lk/en/personnel-licences/commercial-pilot-licence-cpl' },
    { label: 'Civil Aviation Authority of Sri Lanka — frequently asked questions on personnel licences', url: 'https://www.caa.lk/en/faqs/on-personal-licences' },
    { label: 'Civil Aviation Authority of Sri Lanka — Training and Maintenance Organizations', url: 'https://www.caa.lk/en/training-maintenance-organizations' },
  ],
};
...
const FACTS = { LICENCES, MIN_AGE, CPL_HOURS, DGCA_PAPERS, RTR, EDUCATION, MEDICAL, MEDICAL_STANDARDS, ATPL_HOURS_GUIDANCE, ACADEMY, PARIKSHA, EGCA, EXAM_RULES, SYLLABUS, CPL_COST, AVIATION_CAREERS, FTO, FDTL, PAY_NOTE, COST_NOTE, PILOT_SUPPLY, INDIGO_CADET, FOREIGN_LICENCE, SRI_LANKA };
