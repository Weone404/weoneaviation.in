 ...
 *
 * ⚠ SUPERSEDED REVISION — FLAGGED 2026-09-16.
 *   The owner sent a screenshot of DGCA's own CAR index that day. It lists
 *   Series 'C' Part I, Issue II of 12.10.2017, at **Revision 7 dated
 *   01.10.2025**. Every medical figure in MEDICAL_STANDARDS below was read
 *   from Revision 6 of 18 October 2022, so the figures are one revision behind
 *   and may have changed.
 *
 *   NOTHING HAS BEEN RELABELLED. Changing the citation to "Rev. 7" without
 *   reading Rev. 7 would be worse than the stale citation: it would claim a
 *   source we have not seen. The citation stays honest about which revision the
 *   figures came from until someone reads the new one.
 *
 *   TO CLOSE THIS: obtain Series 'C' Part I Rev. 7 (01.10.2025) as a readable
 *   document — dgca.gov.in is not on this environment's egress allowlist, so it
 *   has to be downloaded by the owner and attached. Re-verify every value in
 *   MEDICAL_STANDARDS against it, then update the citation and verifiedOn.
 *
 *   The same index also lists two documents worth having:
 *     Series 'C' Part III, Rev. 1 of 08.10.2025 — Empanelment of Medical
 *       Examiner for Class 1. This is the list that would evidence, or
 *       disprove, the "DGCA medical examiner" titles on /about-us.
 *     Series 'G' Part III, Issue II of 30.01.2019, Revision 2 of 18.11.2025 —
 *       Aviation English Language Proficiency: Training, Test and
 *       Certification. This is the ELP source that does not currently exist on
 *       the site; /blogs/6a97b53c ("Importance of Aviation English") was
 *       redirected to /rtr-a on 16 Sep precisely because no ELP page could be
 *       sourced. With this document, that page can be built properly.
 *
