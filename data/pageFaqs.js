...
const routeContent = {
  ...
  '/pilot-course-training-in-india': {
  title: 'Pilot Course Training in India FAQs',
  questions: [
    ['What is a pilot course in India?', 'A pilot course in India is a structured training pathway that includes DGCA ground classes, flight simulator sessions, medical examinations, and practical flying experience leading to a Commercial Pilot License (CPL).'],
    ['Who can join a pilot course training programme in India?', 'Students typically need 10+2 with Physics and Mathematics, a DGCA Class 1 Medical Certificate, English proficiency, and a minimum age of 17 to begin training.'],
    ['How long does pilot course training in India take?', 'A commercial pilot course generally takes 18 to 24 months, depending on the flying school, weather conditions, aircraft availability, and the student\'s training progress.'],
    ['What does a standard pilot training curriculum include?', 'A standard program includes DGCA ground classes, flight simulator training, radio telephony preparation, flying practice, navigation exercises, night flying, cross-country flying, and DGCA examination preparation.'],
    ['What is the average salary after becoming a commercial pilot?', 'The page lists a First Officer salary of ₹12-20 LPA, Senior First Officer at ₹20-35 LPA, and Captain earnings of ₹50 LPA or more, with higher packages for international airline pilots.'],
    ['What career opportunities are available after commercial pilot training?', 'Graduates can pursue roles such as Airline First Officer, Captain, Charter Pilot, Cargo Pilot, Corporate Pilot, Flight Instructor, Ferry Pilot, and Aviation Safety Officer.'],
    ['Can I get pilot training guidance specifically for Delhi?', 'Yes, We One Aviation assists students in Delhi with career counselling, flying school comparisons, the admission process, DGCA medical guidance, Computer Number registration, and documentation support.'],
    ['How does We One Aviation help with pilot course training in India?', 'We help students choose the right route, understand eligibility, compare schools, prepare for DGCA exams, and plan their next steps based on their budget, goals, and timeline, without any hidden commitments.'],
    ['What does the commercial pilot course fee generally cover?', 'The course fee varies by flying school, aircraft type, and location, and students should also budget for medical examinations, DGCA examination fees, accommodation, and study materials.'],
  ],
},
  '/contact': {
  ...
  questions: [
    ...
    ['What DGCA medical certification is needed for CPL?', 'Candidates need a DGCA Class 1 medical certificate, which covers vision, hearing, cardiovascular, neurological, and general fitness standards required to hold a commercial licence.'],
    ...
    ['How many DGCA exam papers are required for CPL?', 'Candidates must clear six DGCA papers covering Air Navigation, Aviation Meteorology, Air Regulations, Technical General, Technical Specific, and Radio Telephony (RTR).'],
  ],
},
  '/courses/ppl': {
  ...
  questions: [
    ...
    ['What is the minimum age for PPL training in India?', 'Candidates must be at least 17 years old to apply for a Private Pilot License under DGCA rules.'],
    ['How many flying hours are required for a PPL?', 'A PPL requires a minimum of 40 to 50 flight hours, including 20 hours of dual flying with an instructor, 10 hours of solo flying, and 5 hours of cross-country flying.'],
    ['What medical certificate is needed for PPL?', 'Candidates need a DGCA-approved Class 2 Medical Certificate to be eligible for Private Pilot License training.'],
    ['What type of aircraft is used for PPL flight training?', 'PPL training is typically conducted on single-engine aircraft such as the Cessna 152 or Cessna 172.'],
  ],
},
 '/courses/atpl': {
  ...
  questions: [
    ...
    ['How many flight hours are required for an ATPL?', 'Candidates need a minimum of 1,500 flight hours as part of the ATPL experience pathway.'],
    ['How many subjects does the ATPL syllabus cover?', 'The program covers all 14 EASA/DGCA ATPL subjects, including advanced navigation, jet meteorology, aircraft performance, flight planning, air law, human factors, and aircraft systems.'],
    ['Does ATPL training include simulator and type-rating preparation?', 'Yes, the program includes Full Flight Simulator (FFS) sessions, Boeing 737 and Airbus A320 type-rating preparation, ILS/CAT-III approach training, and multi-crew cooperation (MCC) training.'],
    ['What can I expect to earn as an airline captain after ATPL?', 'Average captain salary at major airlines is around ₹5-8 lakh per month, with senior captains earning more.'],
  ],
},
  ...
  questions: [
    ...
    ['Who provides the flight instruction in this PPL program?', 'Training is delivered by experienced Certified Flight Instructors (CFIs) with 5,000+ hours of flying experience, on DGCA-approved training aircraft.'],
    ['Does this PPL program include night flying and radio telephony training?', 'Yes, night flying and radio telephony (RTR) are both included as part of the program, along with cross-country navigation flights and instrument fundamentals.'],
    ['What career prospects follow this PPL program?', 'This PPL program is positioned as a stepping stone toward a CPL and an airline career, with average CPL first-officer salary cited at around ₹1.8-2.5 lakh per month.'],
  ],
},
  ...
  questions: [
    ...
    ['Who can apply for the Emirates Cadet Pilot Program?', 'Applicants generally need to be at least 17 years old, have completed high school with strong grades in Math, Physics, and English, hold an IELTS score of 6.0 or equivalent, and pass a Class 1 Aviation Medical Exam. No prior flying experience is required.'],
  ...
  questions: [
    ...
    ['Who is eligible to take the COMPASS test for the cadet programme?', 'Eligibility listed includes 10+2 with Physics and Mathematics (minimum 50%), a DGCA Class 2 Medical Certificate, age typically 17-26 years, English proficiency, and no prior flying experience required.'],
 ...
 '/flying-school/usa': {
  ...
  questions: [
    ...
    ['Can I speak with a counsellor before choosing a country for training?', 'Yes, We One Aviation\'s aviation career counsellors can guide you through comparing flight-school destinations, DGCA exam preparation, medical tests, and flying school selection.'],
  ],
},
 ...
 '/lead-magnets/cpl-cost-breakdown': {
  ...
  questions: [
    ...
    ['What does We One Aviation\'s own admission procedure include?', 'It includes initial counselling, document verification, application submission, help scheduling Class 2 and Class 1 medical tests, an orientation and enrollment session, and support with education loans and EMI options.'],
 ...
 '/commercial-pilot-license-syllabus': {
  ...
  questions: [
    ...
    ['Why choose We One Aviation to become a pilot?', 'The page cites industry-recognised training programmes, an emphasis on safety and professionalism, practical hands-on training, and placement assistance for aspiring pilots.'],
  ],
},
  '/blogs/aviation-course-after-12th': {
  title: 'How to Become a Pilot After 12th FAQs',
  questions: [
    ['What are the eligibility requirements to become a pilot after 12th?', 'Candidates need a minimum age of 16 for a Student Pilot Licence (18 for CPL), completion of 12th grade with Physics and Mathematics, and a Class 2 medical certificate from a DGCA-approved doctor.'],
  ...
  questions: [
    ...
    ['What is a pilot\'s typical journey with DGCA?', 'It involves getting admission to a DGCA-approved flying school, passing Class 2 and Class 1 medical tests, clearing DGCA exams (Air Navigation, Meteorology, Regulations, etc.), logging the required flying hours (typically 200 for CPL), and receiving the license from DGCA.'],
  ...
  questions: [
    ...
    ['What is the minimum age and flight hours required for SPL?', 'The program lists a minimum age of 16 and requires a minimum of 20 flight hours.'],
    ['Does SPL require a complex DGCA medical?', 'No, the program is highlighted as not requiring complex DGCA medicals, which is part of what makes it a faster and more affordable entry point into flying.'],
    ['What can SPL lead to in terms of career opportunities?', 'SPL can be converted to PPL and eventually CPL, opening the door to commercial pilot career opportunities valued at approximately ₹40-70 lakh in training investment terms.'],
  ],
},
  ...
  questions: [
    ...
    ['What are the entrance steps after 12th?', 'The usual sequence is passing 12th with PCM, clearing the DGCA Class 1 medical, enrolling in a DGCA-approved flying school, completing ground school training in 9 DGCA subjects, logging 200+ flying hours, clearing the DGCA CPL skill test, and receiving the CPL.'],
    ...
    ['Which DGCA medical certificate is needed for PPL versus CPL?', 'The page lists a DGCA Class 2 medical certificate for PPL and a DGCA Class 1 medical certificate for CPL, which should be scheduled early since it checks vision, hearing, cardiovascular health, and overall fitness.'],
  ],
},
  '/how-to-become-a-pilot/in-india': {
  title: 'Becoming a Pilot in India: FAQs',
  questions: [
    ['What is the first step to becoming a pilot in India?', 'Start by checking 10+2 Physics and Mathematics eligibility (minimum 50%) and completing the DGCA Class 1 medical assessment before committing to a training route.'],
    ['How many DGCA exams are required to become a pilot?', 'Candidates must clear all 9 CPL subjects: Air Navigation, Meteorology, Regulations, Technical General, Technical Specific, RTR, Medicine, Human Factors, and Radio Telephony.'],
    ...
    ['What is the pilot salary progression in India?', 'The page lists a Trainee Pilot at ₹25-40K/month, First Officer at ₹1.8-3 LPM, Senior First Officer at ₹3-5 LPM, Captain at ₹5-8 LPM, and Senior Captain at ₹8-15 LPM.'],
  ...
  questions: [
    ...
    ['What support is offered alongside the training programs?', 'The page lists airline placement support, career guidance, expert trainers who are experienced commercial pilots, and continuous 24/7 mentor support throughout the training journey.'],
