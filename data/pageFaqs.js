...
const routeContent = {
  ...
  questions: [
    ...
    ['What approvals and affiliations does We One Aviation Academy have?', 'Being precise, because the word "approved" is used loosely in this industry: DGCA publishes a list of approved Flying Training Organisations, which is for organisations that operate aircraft. A classroom ground school is not on that list, and we are not on it. What we teach is the DGCA syllabus, examined by DGCA on DGCA\'s own portal against a published pass mark, so the standard is the regulator\'s wherever you study. Ask any institute which list it appears on, and go and check it.'],
    ['Who teaches at the academy?', 'Ground instructors who teach the DGCA written subjects, run mock examinations in the DGCA pattern and take doubt-clearing sessions. We name our instructor panel on the about page. What we deliberately do not publish are year-counts, type ratings or licence numbers for them: those were removed across this site because they could not be evidenced, and we would rather show you a short honest list than a long unverifiable one.'],
    ['What facilities and support are available?', 'Structured ground classes in classroom and online modes, doubt-clearing sessions, mock examinations in the DGCA pattern, free end-to-end career counselling, and guidance on choosing a flying training organisation in India or abroad. What we do not have, and will not imply: aircraft and simulators. We do not own either, and the flying happens at partner flying schools.'],
    ['Where is We One Aviation Academy located?', 'C-404, 3rd Floor, Ramphal Chowk, Block C, Palam Extension, Sector-7, Dwarka, New Delhi 110077. Phone +91-9667370747, email info.weoneaviation@gmail.com. Being in Delhi is a practical advantage rather than a slogan: DGCA\'s Central Examination Organisation, four of its approved medical centres and the equivalence body for international-board candidates are all in this city.'],
    ...
    ['Which pilot courses does the academy provide guidance for?', 'The ground-school side of the whole licence ladder \u2014 SPL, PPL, CPL and ATPL \u2014 plus DGCA ground classes and preparation for airline recruitment processes. To be exact about that last one: airline recruitment preparation is for pilots who already hold a licence, and it is a different thing from an ab-initio cadet programme.'],
    ['Does the academy help with flying schools outside India?', 'Yes. One thing we will always raise, because most pages do not: a licence issued by another country\'s regulator is not an Indian licence, and converting it is a required step with its own time and cost that sits outside every training quote you will be shown.'],
  ],
},
  '/contact': {
